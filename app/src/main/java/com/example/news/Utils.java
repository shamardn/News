...
public final class Utils {
    ...
    public static List<Story> fetchStoryData(String requestUrl) {
        ...
        List<Story> stories = extractStoriesArray(jsonResponse);
    ...
    private static List<Story> extractStoriesArray(String jsonResponse) {
        ...
        try {
            ...
            for (int i = 0; i < storiesArray.length(); i++) {
                ...
                stories.add(new Story(section, time, title, url, author));
            }
